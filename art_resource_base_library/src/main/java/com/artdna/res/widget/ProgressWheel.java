...
public class ProgressWheel extends View {
	...
	private void setupBounds(int layout_width, int layout_height) {
		...
		if (!fillRadius) {
			...
			int minValue = Math.min(layout_width - paddingLeft - paddingRight, layout_height
			...
			circleBounds = new RectF(xOffset + barWidth, yOffset + barWidth, xOffset
					+ circleDiameter - barWidth, yOffset + circleDiameter - barWidth);
		} else {
			circleBounds = new RectF(paddingLeft + barWidth, paddingTop + barWidth, layout_width
					- paddingRight - barWidth, layout_height - paddingBottom - barWidth);
		}
	}
